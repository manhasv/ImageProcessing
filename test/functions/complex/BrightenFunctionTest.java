...
/**
 * This class contains all the tests for the BrightenFunction.
 */
public class BrightenFunctionTest {
  @Test
  public void testBrighten() {
    ...
    IComplexFunction func = new BrightenFunction();
    String str = "2 2 255 60 110 110 60 80 90 70 90 100 90 100 110 ";
    IImage imginput = new ImagePPM(2, 2, 255, input);
    IImage result = func.complexGo(imginput, "10");
  ...
  public void testDarken() {
    ...
    IComplexFunction func = new BrightenFunction();
    String str = "2 2 255 40 90 90 40 60 70 50 70 80 70 80 90 ";
    IImage imginput = new ImagePPM(2, 2, 255, input);
    IImage result = func.complexGo(imginput, "-10");
